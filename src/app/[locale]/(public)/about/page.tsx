...
export const metadata: Metadata = {
	title: 'О проекте — Бұзау.kz',
	description:
		'Бұзау.kz — казахстанский маркетплейс для купли-продажи домашних животных, скота, товаров и услуг',
};
		...
		<div className="container py-12 max-w-4xl space-y-20">
			...
			<section className="text-center space-y-5">
				<h1 className="text-4xl font-bold tracking-tight">
					{isKk ? 'Бұзау.kz туралы' : 'О проекте'}
				</h1>
				<p className="text-lg text-muted-foreground max-w-2xl mx-auto">
					{isKk
						? 'Бұзау.kz — Қазақстандағы жануарлар мен мал саудасына арналған хабарландырулар платформасы. Мұнда үй жануарын, ауыл шаруашылығы малын, жем немесе зооқызметтерді жылдам табуға немесе сатуға болады.'
						: 'Бұзау.kz — казахстанская платформа объявлений, созданная специально для торговли животными и всем, что с ними связано. Здесь можно быстро найти или продать домашнего питомца, сельскохозяйственный скот, корма или зоо-услуги.'}
				</p>
				...
				<div className="inline-block rounded-2xl bg-primary/8 border border-primary/20 px-6 py-4 text-sm text-muted-foreground max-w-xl mx-auto">
					{isKk
						? '«Бұзау» — жас, тіршілікке толы жан. Платформаның атауы өсу, жаңарту және тіршілік идеясын бейнелейді.'
			...
			<section>
				<h2 className="text-2xl font-semibold mb-8 text-center">
					{isKk ? 'Неліктен Бұзау.kz?' : 'Почему Бұзау.kz?'}
				</h2>
				<div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
